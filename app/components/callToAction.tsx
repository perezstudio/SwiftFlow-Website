...
export default function CallToAction() {
  return (
    <div className="flex flex-row max-w-full justify-center px-4 md:px-8 py-8 md:py-16 bg-gradient-to-b from-custom-primary to-custom-secondary">
      <div className="flex flex-col w-full max-w-1200 items-center gap-6 bg-white dark:bg-black rounded-3xl p-8">
        ...
        <div className="max-w-lg flex flex-col gap-1">
          ...
          <p className="text-center">
            Bring your ideas to life quickly and easily without writing a single
            line of code. Sign up today and join a community of innovators
            turning their visions into beautifully crafted, fully functional
            apps.
          </p>
        </div>
        <Link

/*
  ...
  - Added the required column `fullBanner` to the `Post` table without a default value. This is not possible if the table is not empty.
  - Added the required column `id` to the `Post` table without a default value. This is not possible if the table is not empty.
  - Added the required column `squareBanner` to the `Post` table without a default value. This is not possible if the table is not empty.
